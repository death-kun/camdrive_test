class hours:
    ...
    def check_time_19(self):
        ...
        for i in range(95, 100, 1):
            line_19.find_elements_by_xpath(
                '//div[@id="time-intervals"]//td//div[@class="time item  button" or @class="time item  detection" or @class="time item  constant" or @class="item empty"]')[
                i].click()
            self.ii = int(i)
    ...
    def check_time_22(self):
        ...
        for i in range(110, 115, 1):
            driver.find_elements_by_xpath('//div[@id="time-intervals"]//td//div[@class="time item  button" or @class="time item  detection" or @class="time item  constant" or @class="item empty"]')[i].click()
            self.ii = int(i)
