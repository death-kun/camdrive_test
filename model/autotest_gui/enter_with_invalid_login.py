    ...
    def autotest(self):
        ...
        try:
            ...
            with open('authorization report.txt', 'a', encoding='utf-8') as f:
                f.write(
                    '"Проверка валидных/невалидных данных" INFO: Проверка выполнена. Отобразилась надпись "Ошибка идентификации".\n')
                f.close()
            ...
            with open('authorization error report.txt', 'a', encoding='utf-8') as f:
                f.write(
                    '"Проверка валидных/невалидных данных" WARNING: Проверка провалилась. Надпись "Ошибка идентификации" не отобразилась.\n')
                f.close()
